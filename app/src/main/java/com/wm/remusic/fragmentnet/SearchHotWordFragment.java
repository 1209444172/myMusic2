        ...
        new AsyncTask<Boolean, Void, Boolean>() {
            ...
            protected void onPostExecute(Boolean load) {
                ...
                for (int i = 0; i < 10; i++) {
                    ...
                    if (xdistance == -1) {
                        xdistance = 0;
                        com.wm.remusic.widget.WidgetController.setLayout(views.get(i), xdistance, ydistance);
                        continue;
                    }
                    xdistance += com.wm.remusic.widget.WidgetController.getWidth(views.get(i - 1)) + distance;
                    if (xdistance + com.wm.remusic.widget.WidgetController.getWidth(views.get(i)) + distance > w) {
                        xdistance = -1;
                        ydistance += 120;
                        i--;
                        continue;
